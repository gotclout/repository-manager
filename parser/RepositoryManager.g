...
credential
//	:	CREDENTIAL_HEADER public_key certificate* CREDENTIAL_END ->^(CREDENTIAL public_key CERT certificate* END)
...
signature
	:	SIGNATURE_HEADER base64 SIGNATURE_END //->(SIG base64 END_SIG)+
	;
validity
